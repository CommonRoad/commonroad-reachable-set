...
def test_check_collision_and_split_rectangles_py(collision_checker_py: PyCollisionChecker):
    ...
    list_rectangles_collision_free = check_collision_and_split_rectangles(collision_checker=collision_checker_py,
