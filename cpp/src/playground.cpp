...
int main() {
    ...
    auto cls_ConfigurationBuilder_py =
            py::module_::import("commonroad_reachset.data_structure.configuration_builder").attr(
    ...
    auto collision_checker = create_curvilinear_collision_checker(vec_vertices_polygons_static,
