...
def test_alias_delay_initialization1(capture):
    ...
    class B(m.A):
        ...
        def f(self):
            print("In commonroad_reachset f()")
...
def test_alias_delay_initialization2(capture):
    ...
    class B2(m.A2):
        ...
        def f(self):
            print("In commonroad_reachset B2.f()")

    # No commonroad_reachset subclass version
    with capture:
        a2 = m.A2()
        m.call_f(a2)
        del a2
