...
sys.path.insert(0, os.path.abspath('../commonroad_reach.egg-info'))
sys.path.insert(0, os.path.abspath('../commonroad_reach/'))
sys.path.insert(0, os.path.abspath('../commonroad_reach/data_structure'))

for x in os.walk('../commonroad_reach'):
    sys.path.insert(0, x[0])

# -- Project information -----------------------------------------------------

project = 'commonroad-reachable-set'
copyright = '2022, ""'
author = ''
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.napoleon', 'sphinx.ext.todo', 'sphinx.ext.viewcode',
                 'sphinx.ext.doctest','sphinx.ext.autosummary', 'm2r2']
