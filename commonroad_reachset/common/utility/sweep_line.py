...
class SweepLine:
    ...
    def create_tree_from_segments(list_segments: List[ReachLine]) -> ToggleSegmentTree:
        """Creates an OnOFFSegmentTree from the list of given segments."""
        ...
        tree = ToggleSegmentTree(p_lat_min_segments, p_lat_max_segments)
    ...
    def create_p_lon_to_rectangles_dictionary(
        ...
        Steps:
            1. Create a dictionary that maps p_lon to list of tuples of p_lat
               from segments
            2. Iterate through p_lon, retrieve relevant tuples of p_lat and
               toggle the status of segments between these p_lat in the
               segment tree. Get intervals of active segments and create
               rectangles.
        """
    ...
    def merge_rectangles_with_same_lateral_coordinates(
        ...
        rectangle with the same lateral coordinates, then do not add to list.
        Instead, the right rectangle is popped and replaced by the merged one.
        """
